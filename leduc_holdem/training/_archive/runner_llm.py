"""[ARCHIVED — LLM-BASED VERSION]

This file is kept for reference only. The active automation runner is
``non_instruction/runner_ni.py``, which uses fully deterministic rule-based
agents and requires no API key.
